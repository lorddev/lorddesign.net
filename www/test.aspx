    ...
    <div align="center">
      <div id="main">
        <div id="hccPhoto" style="background-image: url(images/rotation/irn-bru.jpg);" runat="server">
          ...
          <div id="content">
            ...
            <div id="txt_web" class="textblock" style="display: none;">
              <div class="bodytext">
                expert knowledge in the development of dynamic data-driven web-based applications
                since 1999 • technologies : asp asp.net html dhtml dom css javascript vbscript vb.net
                access sql server movable type macromedia flash dreamweaver ultradev</div>
            </div>
        ...
        <div id="left" style="position: relative; float: left; left: 45px; top: 37px;">
          <img src="images/mill-sys-logo.gif" alt="Millennium Systems" />
        ...
        <div id="outerfoot" style="position: relative; float: right; right: 45px; top: 45px;
          ...
          source: <a href="JScript.js">js</a> <a href="StyleSheet.css">css</a> <a href="write/aspx.txt">aspx</a> <a href="write/code_behind.txt">
            vb</a> | <a href="http://www.lorddesign.net/weblog">blog</a> | <a href="http://www.myspace.com/fiddler56">
              myspace</a> | <a href="http://www.lorddesign.net">reload</a></div>
      </div>
    </div>
  </form>
