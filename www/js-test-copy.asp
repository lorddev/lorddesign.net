...
<table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
  <tr> 
    <td align="right" valign="top"> 
      ...
      <table width="216" cellpadding="0" cellspacing="0" border="0" style="position:
        ...
        <tr> 
          <td width="216" height="18" style="height: 97;"><img src="images/lord-design_title.gif" width="216" height="97"></td>
        </tr>
        <tr> 
          <td width="216" height="18" style="height: 18;">&nbsp;</td>
        </tr>
        <tr> 
          <td width="216"> 
            <table width="216" height="18" cellpadding="0" cellspacing="0" border="0" 
			  id="webtitle"
			  style="width:216px; height:18px; background: url(images/gradients/category_bar.gif) repeat;">
              <tr> 
                <td width="108" height="18"> <img src="images/web-development.gif" width="108" height="18"></td>
                <td width="90" height="18">&nbsp;</td>
                <td width="18" height="18"> <img src="images/down-arrow.gif" width="18" height="18" id="wdown" border="0" 
        ...
        <tr> 
          <td width="216" valign="top" class="bodytext"> 
            <div id="webcell" visible="false" class="bodytext">expert knowledge in the development of dynamic " +  "data-driven web-based appli- cations since 1999 &#149; technologies " +  ": html dhtml dom asp 3.0 asp.net vbscript vb.net ms access windows xp sql " +  "server 2000 macromedia dreamweaver ultradev"</div>
          </td>
        </tr>
        <tr> 
          <td width="216"> 
            <table width="216" height="18" cellpadding="0" cellspacing="0" border="0"
			  style="width:216px;height:18px;background: url(images/gradients/category_bar.gif) repeat;">
              <tr width> 
                <td width="108"> <img src="images/graphic-design.gif" width="108" height="18"></td>
                <td width="90" height="18">&nbsp; </td>
                <td width="18" height="18"><img id="gdown" src="images/down-arrow.gif" width="18" height="18" style="cursor: pointer" onClick="Gdown_Click();" /></td>
              </tr>
            </table>
          </td>
        </tr>
        <tr> 
          <td width="216" valign="top" class="bodytext"> 
            <div id="designcell" class="bodytext"></div>
          </td>
        </tr>
        <tr> 
          <td width="216"> 
            <table width="216" height="18" cellpadding="0" cellspacing="0" border="0"
			  style="width:216px;height:18px;background: url(images/gradients/category_bar.gif) repeat;">
              <tr width> 
                <td width="108"> <img src="images/client-list.gif" width="108" height="18"></td>
                <td width="90" height="18">&nbsp; </td>
                <td width="18" height="18"><img id="ClDown" src="images/down-arrow.gif" width="18" height="18" style="cursor: pointer" onClick="ClDown_Click();" /></td>
              </tr>
            </table>
          </td>
        </tr>
        ...
        <tr> 
          <td width="216"> 
            <table width="216" height="18" cellpadding="0" cellspacing="0" border="0" id="contacttitle"
			  style="width:216px;height:18px; background: url(images/gradients/category_bar.gif) repeat;">
              <tr> 
                <td width="108"> <img src="images/contact-form.gif" width="108" height="18"></td>
                <td width="90" height="18">&nbsp; </td>
                <td> <img id="CoDown" src="images/down-arrow.gif" width="18" height="18" style="cursor: pointer" onClick="CoDown_Click();" /></td>
              </tr>
            </table>
          </td>
        </tr>
  ...
  <tr> 
    <td align="right" valign="bottom" height="82"> 
      <div align="right" style="position: relative; top: -10px; left: -10px; z-index: 1;"><a href="http://www.nextmill.net" target="_blank"><img src="images/nextmill.jpg" width="120" height="31" border="0"></a> 
        &nbsp; <img src="images/lord-design-logo.jpg" width="37" height="55"> 
        <br>
